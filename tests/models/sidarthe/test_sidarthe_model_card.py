...
text = open("tests/models/sidarthe/sidarthe-short.txt").read()
...
artifact = {
    "id": artifact_id,
    "name": "SIDARTHE",
    "description": "SIDARTHE Paper",
    "timestamp": "2023-07-17T19:11:43",
    "file_names": [
        "2020-Modelling the COVID-19 epidemic and implementation of population-wide interventions in Italy-s41591-020-0883-7.pdf"
    ],
    "metadata": {"text": text},
}
...
code_artifact = {
    "id": code_id,
    "name": "SIDARTHE code",
    "description": "test SIDARTHE code",
    "timestamp": "2023-07-17T19:11:43",
...
mock_code = Mock()
mock_code.content = (
    open("tests/models/sidarthe/code/Evaluation_Scenario_2.1.a.ii-Code_Version_A.py")
    .read()
    .encode()
)
...
mock_provenance.json.return_value = {"result": [code_id]}
